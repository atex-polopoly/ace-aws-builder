...
import com.atex.shared.stack.AtexCloudCognitoStack;
...
public class AtexCloudCognitoApp
{
    public static void main(final String[] args)
    {
        ...
        CognitoProperties cognitoProperties = new CognitoProperties(customerName, accountId, region, environmentType);

        new AtexCloudCognitoStack(app, "atex-cloud-cognito", StackProps.builder()
